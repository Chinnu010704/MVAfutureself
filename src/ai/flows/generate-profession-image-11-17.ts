...
const generateProfessionImage11To17Flow = ai.defineFlow(
  ...
  async input => {
    ...
    const { media } = await ai.generate({
        ...
        prompt: [
            {text: `Your most important task is to use the provided photo to generate a new, hyper-realistic, and cinematic image. The new image must portray the student from the photo as a ${profession}, but imagined approximately 15 years older.
