...
export function HomePage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-8 md:p-12 lg:p-24 bg-background animate-fade-in">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
          Visualize your future. Let our AI create a glimpse of the professional you might become.
        </p>
      </div>

      <div className="w-full max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold text-center mb-8">Choose your age group to begin</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Link href="/create/child" className="group">
            <Card className="hover:shadow-2xl h-full flex flex-col hover:border-primary transition-all duration-300 transform hover:-translate-y-2">
